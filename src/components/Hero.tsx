...
export default function Hero() {
  ...
  return (
    <main
      ...
      className="relative min-h-[100svh] overflow-hidden bg-black text-white lg:min-h-screen"
    >
      <div className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.05)_1px,transparent_1px)] bg-[size:56px_56px] opacity-20 lg:bg-[size:96px_96px]" />
      ...
      <header className="relative z-30 mx-auto flex min-h-[76px] max-w-7xl flex-col gap-3 px-4 py-4 md:flex-row md:items-center md:justify-between md:px-6 md:py-0">
        <motion.div
          whileHover={{ x: 4 }}
        ...
        <nav className="grid w-full grid-cols-4 gap-1 font-mono text-[9px] text-white/35 md:flex md:w-auto md:items-center md:gap-10 md:text-sm">
          {navItems.map((item) => (
            <motion.a
              key={item.href}
              href={item.href}
              ...
              className="cursor-pointer border border-white/10 px-2 py-2 text-center md:border-0 md:p-0"
            >
              {item.label}
            </motion.a>
          ))}
        ...
        <motion.button
          ...
          className="hidden border border-white/15 px-4 py-2 font-mono text-xs uppercase tracking-[0.18em] text-white/45 md:block"
        >
          theme
        </motion.button>
      </header>

      <section className="relative z-20 mx-auto max-w-7xl px-4 pb-6 md:px-6 lg:h-[calc(100vh-76px)] lg:pb-5">
        <motion.div
          ...
          className="relative flex w-full overflow-hidden border border-emerald-400/45 bg-black p-3 shadow-[0_0_110px_rgba(16,185,129,0.14)] sm:p-4 lg:h-full"
        >
          <Corners />
          ...
          <div className="flex w-full flex-col lg:h-full">
            <div className="mb-3 flex flex-col gap-2 border-b border-white/20 pb-3 font-mono text-[9px] uppercase tracking-[0.18em] text-white/55 sm:flex-row sm:items-center sm:justify-between sm:text-[10px] sm:tracking-[0.24em]">
              <span>davud.os / hero.interface</span>
              <span className="text-emerald-400">{status}</span>
            </div>

            <div className="grid gap-4 lg:min-h-0 lg:flex-1 lg:grid-cols-[1fr_1fr]">
...
function CreativeProfile({
  ...
  return (
    <motion.div
      ...
      className="relative flex flex-col overflow-hidden border border-white/25 bg-white/[0.02] p-4 sm:p-5 lg:h-full lg:min-h-0"
    >
      <div className="mb-4 inline-flex w-fit items-center gap-3 border border-white/15 bg-white/[0.03] px-4 py-2 font-mono text-[9px] uppercase tracking-[0.18em] text-white/45 sm:text-[10px] sm:tracking-[0.2em]">
      ...
      <h1 className="mt-4 font-mono text-[18vw] font-black leading-[0.82] tracking-[-0.16em] sm:text-[78px] lg:text-[88px] xl:text-[96px]">
      ...
      <p className="mt-4 font-mono text-[10px] uppercase leading-5 tracking-[0.16em] text-white/45 sm:text-[11px] sm:leading-normal sm:tracking-[0.18em]">
      ...
      <div className="mt-6 lg:mt-auto lg:pt-5">
        <div className="grid gap-3 sm:flex sm:flex-wrap sm:items-center">
          <motion.a
            ...
            className="cursor-pointer bg-emerald-400 px-5 py-3 text-center font-mono text-[11px] font-bold uppercase tracking-[0.08em] text-black"
          >
            → get in touch
          </motion.a>
          ...
          <motion.a
            ...
            className="cursor-pointer border border-white/20 bg-black px-5 py-3 text-center font-mono text-[11px] uppercase tracking-[0.08em] text-white/75"
          >
            $ ls work/
          </motion.a>
        </div>
...
function RightDashboard({
  ...
  return (
    <div className="grid gap-3 lg:h-full lg:min-h-0 lg:grid-rows-[auto_0.9fr_1fr]">
      <MetaBar setStatus={setStatus} />
      <SkillsPanel setStatus={setStatus} />

      <div className="grid gap-3 lg:min-h-0 md:grid-cols-[1.05fr_0.95fr]">
...
function SkillsPanel({
  ...
  return (
    <motion.div
      whileHover={{ y: -3 }}
      className="flex flex-col overflow-hidden border border-white/25 bg-white/[0.02] p-4 lg:min-h-0"
    >
      <p className="font-mono text-[10px] uppercase tracking-[0.28em] text-emerald-400">
        core skills
      </p>

      <div className="mt-4 grid grid-cols-2 gap-2 sm:grid-cols-3 lg:flex-1">
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="mt-4 border border-emerald-400/45 bg-emerald-400/10 p-3 font-mono text-[10px] uppercase leading-5 text-white/55 lg:mt-auto"
      >
