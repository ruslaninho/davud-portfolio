      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        <div className="grid items-center gap-10 lg:grid-cols-[0.95fr_1.05fr]">
          ...
          <motion.div
            ...
            className="relative justify-self-end overflow-hidden border border-emerald-400/40 bg-black/75 p-4 shadow-[0_0_90px_rgba(52,211,153,0.13)] backdrop-blur-md lg:w-full lg:max-w-[620px]"
          >
            <Corners />
            ...
            <div className="relative z-10">
              <div className="mb-4 flex items-center justify-between border-b border-emerald-400/20 pb-3 font-mono text-[10px] uppercase tracking-[0.22em]">
              ...
              <div className="mt-4 grid gap-3 md:grid-cols-2">
                <motion.a
                  ...
                  onMouseEnter={() => setStatus("email command ready")}
                  whileHover={{
                    y: -3,
