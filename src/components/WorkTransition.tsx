...
<section
  id="system"
  ref={sectionRef}
  className="relative h-[175vh] bg-black text-white"
>      <div className="sticky top-0 h-screen overflow-hidden bg-black">
        <div className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.045)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.045)_1px,transparent_1px)] bg-[size:96px_96px] opacity-15" />

        <div className="absolute left-1/2 top-1/2 h-[560px] w-[560px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-emerald-400/15 blur-[180px]" />

        <motion.div
          style={{ y: unlockY }}
          className="absolute inset-x-0 bottom-0 z-10 h-full border-t border-emerald-400 bg-emerald-400/10 shadow-[0_-40px_120px_rgba(52,211,153,0.18)]"
        />

        <motion.div
          style={{ opacity: panelOpacity }}
          className="relative z-20 flex h-full items-center justify-center px-6"
        >
          <div className="relative h-[580px] w-full max-w-5xl overflow-hidden border border-white/30 bg-black p-5 shadow-[0_0_120px_rgba(0,0,0,0.8)] md:p-8">
            <Corners />

            <div className="mb-6 flex items-center justify-between border-b border-white/20 pb-5 font-mono text-xs uppercase tracking-[0.26em]">
            ...
            <div className="grid h-[390px] gap-10 md:grid-cols-[300px_1fr] md:items-center">
              ...
              <div className="flex h-full flex-col justify-center overflow-hidden">
                ...
                <div className="mt-5 h-[116px] overflow-hidden">
                  <motion.h2
                    key={`${activeMode.id}-title`}
                    initial={{ opacity: 0, y: 28 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.45, ease: [0.76, 0, 0.24, 1] }}
                    className="font-mono text-[11vw] font-black uppercase leading-none tracking-[-0.15em] md:text-[86px]"
                  >
                    {activeMode.title}
                  </motion.h2>
                </div>
                ...
                <div className="mt-5 h-[76px] overflow-hidden">
                  <motion.p
                    ...
                    className="max-w-xl font-mono text-sm uppercase leading-7 text-white/50"
                  >
                    {activeMode.text}
                  </motion.p>
                </div>

                <div className="mt-7 grid h-[78px] gap-3 md:grid-cols-3">
            ...
            <div className="mt-6 h-[3px] w-full bg-white">
              <motion.div
            ...
            <p className="mt-5 text-center font-mono text-[10px] uppercase tracking-[0.3em] text-white/35">
